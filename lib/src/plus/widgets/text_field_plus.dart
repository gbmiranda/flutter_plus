...
import 'package:flutter_plus/src/plus/components/text_field_mask_plus.dart';
...
class TextFieldX extends StatelessWidget {
  ...
  TextStyle _buildPlaceholderTextStyle() {
    ...
    return TextStyle(
      ...
      decoration: this.placeholder.textDecorationX?.textDecoration,
      decorationColor: this.placeholder.textDecorationX?.color,
      decorationStyle: this.placeholder.textDecorationX?.decorationStyle,
      decorationThickness:
          this.placeholder.textDecorationX?.decorationThickness,
